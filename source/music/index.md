            ...
            <div class="player-section">
                ...
                <div class="controls-wrapper">
                    ...
                    <div class="control-buttons">
                        <button class="control-btn" title="随机播放">🔀</button>
                        ...
                        <button class="control-btn" title="循环模式">🔁</button>
                    </div>

                    <!-- 额外功能 -->
                    <div class="extra-controls">
                        <button class="extra-btn" title="喜欢">❤️</button>
                        <button class="extra-btn" title="下载">⬇️</button>
                        <button class="extra-btn" title="分享">📤</button>
                        <button class="extra-btn" title="评论">💬</button>
                    </div>
                </div>
            </div>
            ...
            <div class="lyrics-section">
                <div class="lyrics-header">
                    ...
                    <div class="lyrics-actions">
                        <button class="lyrics-action-btn" title="翻译">译</button>
                        <button class="lyrics-action-btn" title="全屏">⛶</button>
                    </div>
                </div>
        ...
        <div class="playlist-section">
            <div class="playlist-header">
                <div class="playlist-title">
                    播放列表
                    <span class="playlist-count">3首</span>
                </div>
                <div class="playlist-actions">
                    <button class="lyrics-action-btn" title="清空列表">🗑️</button>
                </div>
            </div>
            <div class="playlist-grid">
                <div class="playlist-item" onclick="playSong(this, '王位', '杨和苏KeyNG')">
                    <div class="playlist-cover" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"></div>
                ...
                <div class="playlist-item" onclick="playSong(this, '金斧子银斧子', '薛之谦')">
                    <div class="playlist-cover" style="background: linear-gradient(135deg, #4ecdc4 0%, #44a08d 100%);"></div>
                    <div class="playlist-info">
                ...
                <div class="playlist-item" onclick="playSong(this, '于是', '邓紫棋')">
                    <div class="playlist-cover" style="background: linear-gradient(135deg, #ffe66d 0%, #f4a261 100%);"></div>
                    <div class="playlist-info">
